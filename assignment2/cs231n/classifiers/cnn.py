...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        H2 = (1 + (H - HH + 2 * pad) / stride) / 2
        W2 = (1 + (W - WW + 2 * pad) / stride) / 2
    ...
    def loss(self, X, y=None):
        ...
        grads['W1'] = self.reg * self.params['W1'] + dW1_sm
        grads['W2'] = self.reg * self.params['W2'] + dW2_sm
        grads['W3'] = self.reg * self.params['W3'] + dW3_sm
        grads['b1'] = db1
        grads['b2'] = db2
        grads['b3'] = db3
        pass
